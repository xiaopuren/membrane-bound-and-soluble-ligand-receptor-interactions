// mTNF-KMC.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
//  main.cpp
//  TNF-KMC-3D-CPT
//
...
int simu_step = 100000000;//1000000000;
...
double mono_cis_Ass_Rate = 0.00047;
double mono_cis_Diss_Rate = 0.00000000000112;    // This 0.1 means the monomer cis will dissociate automatically

double cis_D = 0.5;      // two different cis interaction: (1) two single receptors (2)
double cis_rot_D = 0.005;
double cis_Ass_Rate = 0.1;
double cis_Diss_Rate = 0.00000000000112;

double bond_D = 0.5;
double bond_rot_D = 0.005;
double Ass_Rate = 0.0118; //units: per nanosecond
double Diss_Rate = 0.000000000141;
